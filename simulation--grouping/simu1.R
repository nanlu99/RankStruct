...
Lm=c(100,200) #50+50*(1:3) #number of pairwise comparison
...
S[,i]=a0[i]+0.3/nitem*sin(6*pi*tt/ttlen)+eps/nitem
}
for(i in (nitem*0.1+1):(nitem*0.2)){
S[,i]=a0[i]+0.3/nitem*sin(6*pi*tt/ttlen)
}
...
S[,i]=a0[i]-0.2/nitem*sin(6*pi*tt/ttlen)+eps/nitem
}
for(i in (nitem*0.4+1):(nitem*0.5)){
S[,i]=a0[i]-0.2/nitem*sin(6*pi*tt/ttlen)
}
...
for(i in 1:(nitem*0.1)){
Str[,i]=a0[i]+0.3/nitem*sin(6*pi*tttr/ttlentr)+eps/nitem
}
for(i in (nitem*0.1+1):(nitem*0.2)){
Str[,i]=a0[i]+0.3/nitem*sin(6*pi*tttr/ttlentr)
}
for(i in (nitem*0.2+1):(nitem*0.3)){
Str[,i]=a0[i]+0.3/nitem*sin(6*pi*tttr/ttlentr)-eps/nitem
}
...
for(i in (nitem*0.3+1):(nitem*0.4)){
Str[,i]=a0[i]-0.2/nitem*sin(6*pi*tttr/ttlentr)+eps/nitem
}
for(i in (nitem*0.4+1):(nitem*0.5)){
Str[,i]=a0[i]-0.2/nitem*sin(6*pi*tttr/ttlentr)
}
for(i in (nitem*0.5+1):(nitem*0.6)){
Str[,i]=a0[i]-0.2/nitem*sin(6*pi*tttr/ttlentr)-eps/nitem
}
...
for(i in 1:(nitem*0.1)){
Strgp[,i]=a0[i]+0.3/nitem*sin(6*pi*tttr/ttlentr)
}
for(i in (nitem*0.1+1):(nitem*0.2)){
Strgp[,i]=a0[i]+0.3/nitem*sin(6*pi*tttr/ttlentr)
}
...
for(i in (nitem*0.3+1):(nitem*0.4)){
Strgp[,i]=a0[i]-0.2/nitem*sin(6*pi*tttr/ttlentr)
}
for(i in (nitem*0.4+1):(nitem*0.5)){
Strgp[,i]=a0[i]-0.2/nitem*sin(6*pi*tttr/ttlentr)
}
...
save(mjdg3, res, file = paste0("res/para1.RData"))
